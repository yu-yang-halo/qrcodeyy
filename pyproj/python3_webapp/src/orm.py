...
class ModelMetaclass(type):
    ...
    def __new__(cls, name, bases, attrs):
        ...
        #INSERT INTO `qrcode`.`qrtable` (`qrid`, `qrindex`, `qrcontent`) VALUES ('3', '2123213123', 'rwerwerw');
...
class IntegerField(Field):
    ...
    def __init__(self, name=None, primary_key=True, default=None, ddl='int'):
